  ...
  if (isset($_GET['pagina'])) {
    ...
    <div class="container">
      <div class="col-sm-12 col-md-12 col-lg-12">
        <h3 class="text-center text-white">Listado de Noticias Inactivas</h3>
        <form action="buscarNoticiainactivas.php?pagina=1" method="POST">       
             <div class="input-group-prepend">
               <input id="nombre_noticia" name="nombre_noticia" style="background:black;color:white" type="text" class="form-control" aria-label="Text input with dropdown button" placeholder="Ingrese el título a buscar">
        ...
        <table class="table table-light">
          <thead>
            ...
            <th scope ="col"><a href="noticiasinactivas.php?pagina=1&orden=descripcion&ascendente=<?php echo $asc; ?>" >Descripción</a></th>
