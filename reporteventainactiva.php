...
<body>
    ...
    if(!isset($_GET['pagina'])){
      header("location:reporteventainactiva.php?pagina=1");
      }
      include "conexion.php";
  $sql = "SELECT * FROM ventas WHERE idestados=2 ";
      ...
      <div class="col-sm-12 col-md-12 col-lg-12">
        ...
        <table class="table table-light">
          <thead>
            ...
            <th scope ="col"><a href="reporteventainactiva.php?pagina=1&orden=idventa&ascendente=<?php echo $asc; ?>" >Id</a></th>
            <th scope ="col"><a href="reporteventainactiva.php?pagina=1&orden=idusuario&ascendente=<?php echo $asc; ?>" >Usuario</a></th>
            <th scope ="col"><a href="reporteventainactiva.php?pagina=1&orden=precio_total&ascendente=<?php echo $asc; ?>" >Precio Total</a></th>
            <<th scope ="col"><a href="reporteventainactiva.php?pagina=1&orden=fecha_venta&ascendente=<?php echo $asc; ?>" > Fecha venta</a></th>
      ...
      <div class="container" style="padding-top:40px">
                        <nav arial-label="page navigation">
                            <ul class="pagination justify-content-center">
                                <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : '' ?>"><a class="page-link" href="reporteventainactiva.php?pagina=<?php echo $_GET['pagina'] - 1 ?>">Anterior</a></li>
                                <?php for ($i = 1; $i <= $paginas; $i++) : ?>
                                    <li class="<?php echo $_GET['pagina'] == $i ? 'active' : '' ?>"><a class="page-link" href="reporteventainactiva.php?pagina=<?php echo $i ?>"><?php echo $i ?></a></li>
                                <?php endfor ?>
                                <li class="page-item <?php echo $_GET['pagina'] >= $paginas ? 'disabled' : '' ?>"><a class="page-link" href="reporteventainactiva.php?pagina=<?php echo $_GET['pagina'] + 1 ?>">Siguiente</a></li>
                            </ul>
                        </nav>
                    </div>
